...
const { getValidAccessTokenForClient } = require('../_lib/youtubeOAuth');
...
module.exports = withCors(async (req, res) => {
  ...
  const result = await runPublishYoutubeQueue();
  jsonResponse(res, 200, result);
});

module.exports.runPublishYoutubeQueue = runPublishYoutubeQueue;
